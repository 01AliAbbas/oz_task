        ...
        children: [
            ...
            children: [
              ...
              ServiceButton(
                icon: const ImageIcon(
                  AssetImage("assets/Small Icon.png"),
                  color: Colors.white,
                  size: 24,
                ),
                label: 'Subscribe',
                onTap: () {
                  locator<NavigationService>().navigateTo(Routes.subscribeView);
                },
              ),
              ServiceButton(
                icon:
          ...
          ShopGrid(shops: [
            ShopItem(
                ...
                imagePath: "assets/Place Image Here.png",
                address: "Jl. ZA. Pagar Alam No. 43",
                isOpen: true,
                deliveryTime: 21,
                distance: 2.1,
                rating: 4),
            ShopItem(
                ...
                imagePath: "assets/Place Image Here2.png",
                address: "Jl. ZA. Pagar Alam , Bandar Lamp...",
                isOpen: false,
                deliveryTime: 50,
                distance: 4.8,
                rating: 4.5),
            ShopItem(
                name: "Oz Cafe",
                imagePath: "assets/Place Image 3.png",
                address: "Jl. ZA. Pagar Alam No. 45",
                isOpen: true,
                deliveryTime: 30,
                distance: 5,
                rating: 5),
